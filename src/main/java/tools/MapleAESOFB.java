...
public class MapleAESOFB {
    ...
    public MapleAESOFB(byte[] iv, short mapleVersion) {
        try {
            ...
            log.error("Failed to initialize encryption cipher");
            log.error("Make sure you're using Unlimited Strength Jurisdiction Policy");
            log.error("See https://www.oracle.com/java/technologies/javase-jce-all-downloads.html");
        }
        setIv(iv);
