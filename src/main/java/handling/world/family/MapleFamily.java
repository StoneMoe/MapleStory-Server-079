...
public class MapleFamily implements Serializable {
    ...
    public static Collection<MapleFamily> loadAll() {
        ...
        try {
            ...
            log.error("unable to read family information from sql");
            se.printStackTrace();
        }
        return ret;
    }
    ...
    public MapleFamily(final int fid) {
        ...
        try {
            ...
            if (this.leadername == null || this.members.size() < 2) {
                log.error("Leader " + this.leaderid + " isn't in family " + this.id + ".  Impossible... family is disbanding.");
                this.proper = false;
                return;
            }
    ...
    public void writeToDB(final boolean bDisband) {
        try {
            ...
            log.error("Error saving family to SQL");
            se.printStackTrace();
        }
    }
