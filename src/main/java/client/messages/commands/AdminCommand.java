...
public class AdminCommand {
    ...
    public static class DestroyReactor extends CommandExecute {
        ...
        public int execute(final MapleClient c, final String[] splitted) {
            ...
            final List<MapleMapObject> reactors = map.getMapObjectsInRange(c.getPlayer().getPosition(), Double.POSITIVE_INFINITY, Collections.singletonList(MapleMapObjectType.REACTOR));
    ...
    public static class KillAll extends CommandExecute {
        ...
        public int execute(final MapleClient c, final String[] splitted) {
            ...
            final List<MapleMapObject> monsters = map.getMapObjectsInRange(c.getPlayer().getPosition(), range, Collections.singletonList(MapleMapObjectType.MONSTER));
            for (final MapleMapObject monstermo : map.getMapObjectsInRange(c.getPlayer().getPosition(), range, Collections.singletonList(MapleMapObjectType.MONSTER))) {
    ...
    public static class MakeOfflineP extends CommandExecute {
        ...
        public int execute(final MapleClient c, final String[] splitted) {
            try {
                c.getPlayer().dropMessage(6, "Making playerNPC...");
                final MapleClient cs = new MapleClient(null, null, new MockIOSession());
    ...
    public static class RemoveItemOff extends CommandExecute {
        ...
        public int execute(final MapleClient c, final String[] splitted) {
            ...
            final java.sql.Connection dcon = DatabaseConnection.getConnection();
            try {
                int id = 0;
                ...
                final PreparedStatement ps2 = dcon.prepareStatement("delete from inventoryitems WHERE itemid = ? and characterid = ?");
    ...
    public static class Packet extends CommandExecute {
        ...
        public int execute(final MapleClient c, final String[] splitted) {
            ...
            c.getPlayer().dropMessage(packetheader + "已传送封包[" + mplew.getPacket().getBytes().length + "] : " + mplew);
            return 1;
        }
    }
    ...
    public static class mob extends CommandExecute {
        ...
        public int execute(final MapleClient c, final String[] splitted) {
            ...
            for (final MapleMapObject monstermo : c.getPlayer().getMap().getMapObjectsInRange(c.getPlayer().getPosition(), 100000.0, Collections.singletonList(MapleMapObjectType.MONSTER))) {
