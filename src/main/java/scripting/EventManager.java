...
public class EventManager {
    ...
    public void cancel() {
        try {
            ...
            log.info("Event name : " + this.name + ", method Name : cancelSchedule:\n" + ex);
        ...
        return Timer.EventTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    log.info("Event name : " + EventManager.this.name + ", method Name : " + methodName + ":\n" + ex);
    ...
    public void startInstance(final MapleCharacter character, final String leader) {
        try {
            ...
            log.info("Event name : " + this.name + ", method Name : setup-Guild:\n" + ex);
    ...
    public void startInstance_CharID(final MapleCharacter character) {
        try {
            ...
            log.info("Event name : " + this.name + ", method Name : setup-CharID:\n" + ex);
    ...
    public void startInstance(final MapleCharacter character) {
        try {
            ...
            log.info("Event name : " + this.name + ", method Name : setup-character:\n" + ex);
    ...
    public void startInstance(final MapleParty party, final MapleMap map) {
        try {
            ...
            log.info("Event name : " + this.name + ", method Name : setup-partyid:\n" + ex);
    ...
    public void startInstance_NoID(final MapleParty party, final MapleMap map, final Exception old) {
        try {
            ...
            log.info("Event name : " + this.name + ", method Name : setup-party:\n" + ex);
    ...
    public void startInstance(final EventInstanceManager eim, final String leader) {
        try {
            ...
            log.info("Event name : " + this.name + ", method Name : setup-leader:\n" + ex);
    ...
    public void startInstance(final MapleSquad squad, final MapleMap map, final int questID) {
        ...
        try {
            ...
            log.info("Event name : " + this.name + ", method Name : setup-squad:\n" + ex);
